...
using static ce205_hw5_needleman_smith_hunt.Class1.NeedlemanWunsch;
using static System.Windows.Forms.VisualStyles.VisualStyleElement;

namespace ce205_hw4_application_cs
{
    public partial class needleman_form : Form
    {
        string input1, input2;
        public needleman_form()
        {
            InitializeComponent();
        }
        ...
        private void needleman_form_Load(object sender, EventArgs e)
        {
