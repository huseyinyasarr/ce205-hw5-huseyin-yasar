...
using static ce205_hw5_needleman_smith_hunt.Class1.HuntSzymanski;

/**
 * @file ce205-application-cs.cs
...
{
    public partial class hunt_form : Form
    {
        public hunt_form()
        {
            InitializeComponent();
        ...
        private void hunt_form_Load(object sender, EventArgs e)
        {
